  ...
  table.on('tool(list)', function(obj){
    ...
    if(obj.event === 'show'){
      ...
      layer.confirm('真的删除行么', function(index){
        ...
        czAdminUserAuthority("/adminuserauthority/delete",jsonEntity,obj);
        layer.close(index);
      });
      ...
      layer.open({
        ...
        shade:0.6,
  		...
  		success:function(){
        form.val("updAdminUserAuthorityForm", {
    "menuid": data.menuid,
        });

  		          //监听提交
			  form.on('submit(submitUpdAdminUserAuthority)', function(FormData){
    ...
    $("#delBatchAdminUserAuthority").click(function(){
