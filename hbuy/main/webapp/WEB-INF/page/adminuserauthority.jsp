...
<body>
 ...
 <div style="display: none;margin-top: 20px;" id="updAdminUserAuthorityDiv">
  <form class="layui-form" action="" lay-filter="updAdminUserAuthorityForm">
 ...
 <div style="margin: 20px;">
    <fieldset class="layui-elem-field layui-field-title" style="margin-top: 30px;">
        <legend>AdminUserAuthority显示页面</legend>
    </fieldset>
    <div class="layui-btn-group listTable">
	  <button class="layui-btn" id="flush"><i class="layui-icon">&#x1002;</i>刷新</button> 
	</div> 
	<div class="layui-btn-group listTable">  
	  <button class="layui-btn layui-btn-danger" id="delBatchAdminUserAuthority"><i class="layui-icon">&#xe640;</i>批量删除</button>
	</div>
	<div class="layui-btn-group listTable">  
 ...
 <script src="js/adminuserauthority.js"></script>
</body>
</html>
