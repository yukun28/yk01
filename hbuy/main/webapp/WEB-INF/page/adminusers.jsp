	    ...
	    <div class="layui-inline">
	      ...
	      <div class="layui-input-inline">
	        <input type="text" name="userheader" lay-verify="required" autocomplete="off" placeholder="请输入用户头像"  class="layui-input" id="userheader">
		                 ...
		                 <div class="layui-form-item">
	    <div class="layui-inline">
	      <label class="layui-form-label">是否显示（1显示0隐藏）</label>
	      <div class="layui-input-inline">
	        <input type="text" name="isdisplay" lay-verify="required" autocomplete="off" placeholder="请输入是否显示（1显示0隐藏）"  class="layui-input" id="isdisplay">
	      </div>
	    </div>
	   </div>
		       <div class="layui-form-item">
